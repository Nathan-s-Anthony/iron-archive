...
export default function CampaginTimeline() {
  ...
  useGSAP(
    () => {
      ...
      const nationsHeading = nationsContainer.querySelector(".nations-heading");
  ...
  return (
    <div ref={campaignsContainer} className="">
...
{
  /* <section className="min-h-300" id="introduction">
        <div className="container">
          <div className="flex flex-col justify-end py-6 items-center">
            <span className="text-primary/60 mb-0 mt-0">Introduction</span>
            <h1 className="text-primary text-center">Normandy Campaign</h1>
      ...
      <section
        className="flex flex-col bg-red-500 min-h-300 justify-end py-6 items-center"
        id="nations-container"
      >
        <span className="text-primary/60 mb-0 mt-0">Participanted</span>
        <h1 className="text-primary text-center nation-heading">Nations</h1>
        <p className="max-w-xl mt-6 mb-6 text-center nation-desc">
          A comprehensive field dossier covering the major campaigns and
          theatres of the Second World War, from the opening offensives of 1939
          to the final campaigns of 1945.
        </p>
      </section>
    </div> */
}
